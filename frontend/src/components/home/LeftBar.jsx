...
const LeftBar = ()=>{
    return (
        <>
            <div className="bg-inherit w-[329px] h-[100vh]">
                <div className="h-[82px] w-[289px] bg-[rgba(252,252,253,1)] m-[25px] rounded-[8px] flex items-center p-[8px]">
                <img src="images/profile-image.jpeg" alt="Profile image" className='w-10 h-10 rounded-[8px] ml-[10px]' />
                <div className="ml-[10px]">
                    <h3 className="text-[#18263a] font-bold text-[15px]">Soham Chavan</h3>
                    <p className="text-[#324c70] italic text-[12px]">@sohamchavan123</p>
                </div>
                </div>
                <div className="h-[320px] w-[289px] bg-[rgba(252,252,253,1)] m-[25px] rounded-[8px]">
                ...
                <div className="h-[30px] w-[264px] my-[25px] ml-[50px] text-[rgba(172,182,196,255)] font-bold">INVITATIONS</div>
                <div className="h-[420px] w-[289px] bg-[rgba(252,252,253,1)] m-[25px] rounded-[8px] flex flex-col items-center p-[8px]">
